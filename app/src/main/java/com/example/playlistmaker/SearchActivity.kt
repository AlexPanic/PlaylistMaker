...
class SearchActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Список треков
        val mockTracks = arrayListOf<Track>(
            ...
            Track("Sweet Child O'Mine","Guns N' Roses", "5:03", "https://is5-ssl.mzstatic.com/CHECKPLACEHOLDERimage/thumb/Music125/v4/a0/4d/c4/a04dc484-03cc-02aa-fa82-5334fcb4bc16/18UMGIM24878.rgb.jpg/100x100bb.jpg")
        )

        val trackList = findViewById<RecyclerView>(R.id.trackList)
        trackList.layoutManager = LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false)
        trackList.adapter = TrackAdapter(mockTracks)
